...
<head>
    ...
    <script src="js/json-caption-cp-alzheimer-0220161106v2.js" type="text/javascript"></script>
</head>
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1>
                    <a href="cp-alzheimer-0220161106v2.html"><img src="images/ucm-ws.png" alt=""/>CAM ASSISTANT</a>
                </h1>
            </div>
                ...
                <div class="grid-info">
                    <div class="col-md-12">
                        <div class="center_element">
                            <input type="hidden" id="videoFile1" size="60" maxlength="250" class="tooltip_ video_cam" style="width: 450px;" title="Video 1 file input field"
                                   value="videos/video-disorientation-atmidnight.mp4" readonly="readonly"/>
                            <button type="button" id="buttom_load_video" class="btn btn-md btn-primary" style="width: 120px">Show Videos</button>
                        </div>
                        ...
                        <div class="area-grids-heading heading-video">
                            <div id="cam-title" class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    En este caso práctico se propone una simulación que muestra un paciente con desorientación. Lo que se define en la simulación es la posibilidad de detectar que el paciente está más de 10 minutos fuera de la habitación entre las 0:00 y las 8:00 y se le indica que vuelva a la cama encendiendo las luces de la habitación y los pasillos.
                                </div>
                                <input type="hidden" id="id_cp" name="id_cp" value="CAMASSISTANT-CP000002" />
                            <input type="hidden" id="id_cam" name="id_cam" value="CP000002-CAM1-VI01-20161015" class="id_cams"/>
                            </div>
                            <br/>
                        </div>
                        <div id="graph-1" class="video-js-responsive-container vjs-hd">
                            <video id="Video1" preload="auto" class="video-js vjs-default-skin" style="border: 1px solid green;" width="auto" height="auto"
