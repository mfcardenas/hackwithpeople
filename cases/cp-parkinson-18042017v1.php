...
<head>
    ...
    <script src="js/json-caption-cp-parkinson-vim-18042017v1.js" type="text/javascript"></script>
...
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1>
                    <a href="cp-parkinson-18042017v1.html"><img src="images/ucm-ws.png" alt=""/>CAM ASSISTANT</a>
                </h1>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="center_element">
                            <input type="hidden" id="videoFile1" maxlength="250" class="tooltip_ video_cam form-control" style="width: 450px;" title="Video 1 file input field"
                                   value="videos/video_parkinson_CP000002-CAM1-VPM.mov" readonly="readonly"/>
                ...
                <div class="col-md-8 agile-bottom-right">
                    <div class="agile-bottom-grid">
                        ...
                        <form data-toggle="validator" action="https://docs.google.com/macros/exec?service=AKfycbwlJPs3FdUvsT73pzavO08CF-98rTLK0NA2GRQboU6AHBD6NjXD"  method="POST" role="form" name="theForm" id="theForm" target="hidden_iframe">
                            ...
                            <fieldset class="row">
                                <label>
                                    <input required type="text" id="name" name="name" placeholder="Enter tour name *" data-constraints="@LettersOnly @NotEmpty"
                                    title="Enter your name"/>
                                    <div class="help-block with-errors"></div>
                                </label>
                                <label>
                                    <input type="text" id="email" name="email" placeholder="Enter your email *" data-constraints="@Email @NotEmpty" title="Enter your email"/>
                                    <div class="help-block with-errors"></div>
                                </label>
                                <label>
                                    <select id="type_stude" name="type_stude" required>
                                        <option value="">Your training is ...</option>
                                        <option value="BA">Baccalaureate</option>
                                ...
                                <label>
                                    <select id="considerate" name="considerate" required>
                                        <option value="">Do you find it interesting?</option>
                                        <option value="S">Yes, it is interesting.</option>
                                        <option value="N">No, I do not see it relevant.</option>
                                    </select>
                                    <div class="help-block with-errors"></div>
                                </label>
                                <label>
                                ...
                                <label>
                                    <input required type="text" id="control" name="control" placeholder="4-digit" data-constraints="@Number"
                                    title="To prevent spam, please enter any 4-digit number" size="8" maxlength="20"/>
                                    <img src="images/img-question-gif.png" width="22" height="22" title="To prevent spam, please enter any 4-digit number"/>
                                    <div class="help-block with-errors"></div>
                                </label>
                                <label>
                                    <button type="button" id="send-send" name="send-send" class="btn btn-md btn-primary">Send</button>
                                ...
                                <label>
                                    <button type="button" id="send-cancel" name="send-cancel"  class="btn btn-md btn-primary">Cancel</button>
                                </label>
                        ...
                        <div class="area-grids-heading heading-video">
                            <div id="cam-title" class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Description of the case study.</h3>
                                </div>
        ...
        <!-- footer -->
        <div class="footer">
            <p>© 2017 <a href="http://grasia.fdi.ucm.es/colosaal/" target="_blank">ColosAAL</a> - <a href="http://ucm.es" target="_blank">Universidad Complutense de Madrid</a></p>
        </div>
        <!-- //footer -->
    </section>
</body>
