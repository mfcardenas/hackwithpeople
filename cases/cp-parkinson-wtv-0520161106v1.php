...
<head>
    ...
    <script src="js/json-caption-cp-parkinson-wtv-0520161106v1.js" type="text/javascript"></script>
</head>
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1>
                    <a href="cp-parkinson-wtv-0520161106v1.html"><img src="images/ucm-ws.png" alt=""/>CAM ASSISTANT</a>
                </h1>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="center_element">
                            <input type="hidden" id="videoFile1" size="60" maxlength="250" class="tooltip_ video_cam" style="width: 450px;" title="Video 1 file input field"
                                   value="videos/video-parkinson-patient-watching-TV.mp4" readonly="readonly"/>
                    ...
                    <div class="agile-bottom-grid">
                        ...
                        <div class="area-grids-heading heading-video">
                            <div id="cam-title" class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    Se simula un caso práctico de la enfermedad con pacientes realizando actividades cotidianas como ver televisión. El objetivo es poder estudiar el comportamiento del individuo realizando la actividad con la ayuda de otros dispositivos electrónicos comunes.
                                </div>
                                <input type="hidden" id="id_cp" name="id_cp" value="CAMASSISTANT-CP000004" />
                                <input type="hidden" id="id_cam" name="id_cam" value="CP000004-CAM1-VI01-20161015" class="id_cams"/>
                            </div>
                            <br/>
                        </div>
                        <div id="graph-1" class="video-js-responsive-container vjs-hd">
                            <video id="Video1" preload="auto" class="video-js vjs-default-skin" style="border: 1px solid green;" width="auto" height="auto"
                                   poster="images/fondo_viedeos.png" data-setup="{{'fluid': true}}"
