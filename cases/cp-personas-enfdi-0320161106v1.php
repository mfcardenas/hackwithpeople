...
<head>
    ...
    <script src="js/json-caption-cp-personas-enfdi-0320161106v1.js" type="text/javascript"></script>
</head>
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1>
                    <a href="cp-personas-enfdi-0320161106v1.html"><img src="images/ucm-ws.png" alt=""/>CAM ASSISTANT</a>
                </h1>
            </div>
                        ...
                        <div class="area-grids-heading heading-video">
                            <div id="cam-title" class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    Simular el comportamiento de las personas en espacios abiertos permite analizar factores que podrían afectar a usuarios con limitaciones. En este sencillo ejemplo solo se simula la entrada de estudiantes a la facultad por la entrada principal. Se podría ampliar el caso práctico para usuarios con ciertas limitaciónes.
                                </div>
                                <input type="hidden" id="id_cp" name="id_cp" value="CAMASSISTANT-CP000003" />
                                <input type="hidden" id="id_cam" name="id_cam" value="CP000003-CAM1-VI01-20161015" class="id_cams"/>
                            </div>
                            <br/>
                        </div>
