...
<head>
    ...
    <script src="js/json-caption-cp-multitudes-0420161110v1.js" type="text/javascript"></script>
</head>
...
<script type="text/javascript">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1>
                    <a href="cp-multitudes-0420161110v2.html"><img src="images/ucm-ws.png" alt=""/>CAM ASSISTANT</a>
                </h1>
            </div>
        ...
        <div class="main-grid">
                ...
                <div class="grid-info">
                    <div class="col-md-12">
                        <div class="center_element">
                            <input type="hidden" id="videoFile1" size="40" maxlength="250" class="tooltip_ video_cam" style="width: 350px;" title="Video 1 file input field"
                                   value="videos/multitudes_cam_7_15-1min.mp4" readonly="readonly"/>
                            <input type="hidden" id="videoFile2" size="40" maxlength="250" class="tooltip_ video_cam" style="width: 350px;" title="Video 2 file input field"
                                   value="videos/multitudes_cam_1_9-1min.mp4" readonly="readonly"/>
                            <input type="hidden" id="videoFile3" size="40" maxlength="250" class="tooltip_ video_cam" style="width: 350px;" title="Video 3 file input field"
                                   value="videos/multitudes_cam_5_13-1min.mp4" readonly="readonly"/>
                            <input type="hidden" id="videoFile4" size="40" maxlength="250" class="tooltip_ video_cam" style="width: 350px;" title="Video 4 file input field"
                                   value="videos/multitudes_cam_4_12-1min.mp4" readonly="readonly"/>
                            <button type="button" id="buttom_load_video" class="btn btn-md btn-primary" title="Load Videos" style="width: 120px">Show Videos</button>
                        </div>
            ...
            <div class="social grid">
                <div class="grid-info col-md-12">
                    <div id="cam-title" class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Descripción del caso de estudio</h3>
                        </div>
                        <div class="panel-body">
                            Se simula el comportamiento de multitudes dentro de grandes superficies como es el caso de la Facultad de Informática, para observar el flujo de personas en las diferentes zonas del recinto. A continuación se disponen de cuatro cámaras para observar el comportamiento de los individuos en diferentes lugares.
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="agile-bottom-grids">
			    ...
			    <input type="hidden" id="id_cp" name="id_cp" value="CAMASSISTANT-CP000005" />
                            <input type="hidden" id="id_cam_1" name="id_cam_1" value="CP000005-CAM1-VI01-20161015" class="id_cams"/>
                        </div>
                        <div id="graph-1" class="video-js-responsive-container vjs-hd">
                            <video id="Video1" preload="auto" class="video-js vjs-default-skin" style="border: 2px solid red;"
                ...
                <div class="col-md-6 agile-bottom-left">
                    <div class="agile-bottom-grid">
                        <div class="area-grids-heading heading-video">
                            <h3 class="active"><a data-toggle="collapse" href="#graph-2">Camera 2</a></h3>
                            <input type="hidden" id="id_cam_2" name="id_cam_2" value="CP000005-CAM2-VI02-20161015" class="id_cams"/>
                        </div>
                        <div id="graph-2" class="video-js-responsive-container vjs-hd">
                            <video id="Video2" preload="auto" class="video-js vjs-default-skin" style="border: 2px solid green;"
                                   width="auto" height="auto"
                                   data-setup="{{'fluid': true}}"
                                   title="Case Practical Comment Video"
                                   poster="images/fondo_viedeos.png" >
                        ...
                        <div class="area-grids-heading">
                            <div id="demo-tools-2" style="display: none;">
                                <h3 class="demo-box-title active panel-title">
                                    <a data-toggle="collapse" href="#collapse2"><span class="expand-tools">[+]</span> Tools Comments Video - Camera 2</a>
                                </h3>
                                <div id="collapse2" class="panel-collapse collapse">
                                    <div class="demo-box">
                                        <ul class="demo-tool-buttons" id="tools_2">
                                            <li id="increase-font-2" class="increase-font">
                                                <img src="images/font_inc.png" width="22" height="22" alt="Zoom in Tags" title="Zoom in Tags" class="tooltip_"/>
                                            </li>
                                            <li id="decrease-font-2" class="decrease-font">
                                                <img src="images/font_dec.png" width="22" height="22" alt="Zoom out Tags" title="Zoom out Tags" class="tooltip_"/>
                                            </li>
                                            <li id="none1-tag-2" class=""></li>
                                            <li id="none2-tag-2" class=""></li>
                                            <li id="none3-tag-2" class=""></li>
                                            <li id="none4-tag-2" class=""></li>
                                            <li id="add-tag-2" class="dynamic-demo-add-tag" style="align-self: flex-end;">
                                                <img src="images/create_comment.png" width="30" height="30" title="Add Comment" alt="Add Comment" class="tooltip_"/>
                                            </li>
                                    ...
                                    <div class="demo-box" role="group" aria-label="...">
                                        <input type="hidden" id="ct_2" name="ct_2" />
                                        <label for="bottom_text_tag_2">Short Comment:&nbsp;*</label>
                                        <input type="text" id="bottom_text_tag_2" name="bottom_text_tag_2" disabled="disabled" value="" size="50" maxlength="50" required placeholder="Short Comment visible in Video"/><br/>
                                        <label for="text_tag_2">Long Comment:&nbsp;</label>
                                        <textarea id="text_tag_2" name="text_tag_2" rows="3" cols="70" disabled="disabled" style="resize: none;" placeholder="Long Comment of camera, not visible in video"></textarea><br/>
                                        <label for="textOver_2">Options Short Comment:&nbsp;</label>
                                        <div class="checkbox" id="buttom_2">
                                            <label>
                                                <input id="dynamic-demo-bold-2" name="dynamic-demo-bold-2" type="checkbox">
                                                <img src="images/bold.png" class="button-edit tooltip_" width="22" height="22" title="Bold Text" alt="Bold"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-demo-italy-2" name="dynamic-demo-italy-2" type="checkbox">
                                                <img src="images/italic.png" class="button-edit tooltip_" width="22" height="22" title="Italy Text" alt="Italy"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-underline-2" name="dynamic-demo-underline-2" type="checkbox">
                                                <img src="images/underline.png" class="button-edit tooltip_" width="22" height="22" title="Underline Text" alt="Underline"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-left-2" name="dynamic-demo-left-2" type="checkbox">
                                                <img src="images/left.png" class="button-edit tooltip_" width="22" height="22" title="Left Text" alt="Left"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-center-2" name="dynamic-demo-center-2" type="checkbox">
                                                <img src="images/center.png" class="button-edit tooltip_" width="22" height="22" title="Center Text" alt="Center"/>
                                            </label>&nbsp;&nbsp;
                                            <img src="images/save.png" class="dynamic-demo-add button-edit tooltip_" width="22" height="22" title="Save" alt="Save"/>
                                            &nbsp;&nbsp;
                                        ...
                                        <input type="hidden" id="textOver_2" name="textOver_2" />
                                        <input type="hidden" id="id_2" name="id_2" />
                                        <input type="hidden" id="ed_2" name="ed_2" value="N" />
                                    </div>
                                    <div class="demo-box" >
                                        <ul id='marker-list-2' class="dynamic-demo-events list-group tag-list">
                                        </ul>
                                    </div>
                                    <div id="text-controls_2" class="demo-edit-buttons">
                                </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="agile-grids">
                <div class="col-md-6 charts-right">
                    ...
                    <div class="area-grids">
                        <div class="area-grids-heading heading-video">
                            <h3 class="active"><a data-toggle="collapse" href="#graph-3">Camera 3</a></h3>
                            <input type="hidden" id="id_cam_3" name="id_cam_3" value="CP000005-CAM3-VI03-20161015" class="id_cams"/>
                        </div>
                        <div id="graph-3" class="video-js-responsive-container vjs-hd">
                            <video id="Video3" preload="auto" class="video-js vjs-default-skin" style="border: 2px solid yellow;"
                                   width="auto" height="auto"
                                   data-setup="{{'fluid': true}}"
                                   title="Case Practical Comment Video"
                                   poster="images/fondo_viedeos.png" >
                        ...
                        <div class="area-grids-heading">
                            <div id="demo-tools-3" style="display: none;">
                                <h3 class="demo-box-title active panel-title">
                                    <a data-toggle="collapse" href="#collapse3"><span class="expand-tools">[+]</span> Tools Comments Video - Camera 3</a>
                                </h3>
                                <div id="collapse3" class="panel-collapse collapse">
                                    <div class="demo-box">
                                        <ul class="demo-tool-buttons" id="tools_3">
                                            <li id="increase-font-3" class="increase-font">
                                                <img src="images/font_inc.png" width="22" height="22" alt="Zoom in Tags" title="Zoom in Tags" class="tooltip_"/>
                                            </li>
                                            <li id="decrease-font-3" class="decrease-font">
                                                <img src="images/font_dec.png" width="22" height="22" alt="Zoom out Tags" title="Zoom out Tags" class="tooltip_"/>
                                            </li>
                                            <li id="none1-tag-3" class=""></li>
                                            <li id="none2-tag-3" class=""></li>
                                            <li id="none3-tag-3" class=""></li>
                                            <li id="none4-tag-3" class=""></li>
                                            <li id="add-tag-3" class="dynamic-demo-add-tag" style="align-self: flex-end;">
                                                <img src="images/create_comment.png" width="30" height="30" title="Add Comment" alt="Add Comment" class="tooltip_"/>
                                            </li>
                                    ...
                                    <div class="demo-box" role="group" aria-label="...">
                                        <input type="hidden" id="ct_3" name="ct_3" />
                                        <label for="bottom_text_tag_3">Short Comment:&nbsp;*</label>
                                        <input type="text" id="bottom_text_tag_3" name="bottom_text_tag_3" disabled="disabled" value="" size="50" maxlength="50" required placeholder="Short Comment visible in Video"/><br/>
                                        <label for="text_tag_3">Long Comment:&nbsp;</label>
                                        <textarea id="text_tag_3" name="text_tag_3" rows="3" cols="70" disabled="disabled" style="resize: none;" placeholder="Long Comment of video, not visible in video"></textarea><br/>
                                        <label for="textOver_3">Options Short Comment:&nbsp;</label>
                                        <div class="checkbox" id="buttom_3">
                                            <label>
                                                <input id="dynamic-demo-bold-3" name="dynamic-demo-bold-3" type="checkbox">
                                                <img src="images/bold.png" class="button-edit tooltip_" width="22" height="22" title="Bold Text" alt="Bold"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-demo-italy-3" name="dynamic-demo-italy-3" type="checkbox">
                                                <img src="images/italic.png" class="button-edit tooltip_" width="22" height="22" title="Italy Text" alt="Italy"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-underline-3" name="dynamic-demo-underline-3" type="checkbox">
                                                <img src="images/underline.png" class="button-edit tooltip_" width="22" height="22" title="Underline Text" alt="Underline"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-left-3" name="dynamic-demo-left-3" type="checkbox">
                                                <img src="images/left.png" class="button-edit tooltip_" width="22" height="22" title="Left Text" alt="Left"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-center-3" name="dynamic-demo-center-3" type="checkbox">
                                                <img src="images/center.png" class="button-edit tooltip_" width="22" height="22" title="Center Text" alt="Center"/>
                                            </label>&nbsp;&nbsp;
                                            <img src="images/save.png" class="dynamic-demo-add button-edit tooltip_" width="22" height="22" title="Save" alt="Save"/>
                                            &nbsp;&nbsp;
                                        ...
                                        <input type="hidden" id="textOver_3" name="textOver_2" />
                                        <input type="hidden" id="id_3" name="id_3" />
                                        <input type="hidden" value="N" id="ed_3" name="ed_3" />
                                    </div>
                                    <div class="demo-box" >
                                        <ul id='marker-list-3' class="dynamic-demo-events list-group tag-list">
                                        </ul>
                                    </div>
                                    <div id="text-controls_3" class="demo-edit-buttons">
                                </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 chart-left">
                    ...
                    <div class="agile-Updating-grids">
                        <div class="area-grids-heading heading-video">
                            <h3 class="active"><a data-toggle="collapse" href="#graph-4">Camera 4</a></h3>
                            <input type="hidden" id="id_cam_4" name="id_cam_4" value="CP000005-CAM4-VI04-20161015" class="id_cams"/>
                        </div>
                        <div id="graph-4" class="video-js-responsive-container vjs-hd">
                            <video id="Video4" preload="auto" class="video-js vjs-default-skin" style="border: 2px solid blue;"
                                   width="auto" height="auto"
                                   data-setup="{{'fluid': true}}"
                                   title="Case Practical Comment Video"
                                   poster="images/fondo_viedeos.png" >
                        ...
                        <div class="area-grids-heading">
                            <div id="demo-tools-4" style="display: none;">
                                <h3 class="demo-box-title active panel-title">
                                    <a data-toggle="collapse" href="#collapse4"><span class="expand-tools">[+]</span> Tools Comments Video - Camera 4</a>
                                </h3>
                                <div id="collapse4" class="panel-collapse collapse">
                                    <div class="demo-box">
                                        <ul class="demo-tool-buttons" id="tools_4">
                                            <li id="increase-font-4" class="increase-font">
                                                <img src="images/font_inc.png" width="22" height="22" alt="Zoom in Tags" title="Zoom in Tags" class="tooltip_"/>
                                            </li>
                                            <li id="decrease-font-4" class="decrease-font">
                                                <img src="images/font_dec.png" width="22" height="22" alt="Zoom out Tags" title="Zoom out Tags" class="tooltip_"/>
                                            </li>
                                            <li id="none1-tag-4" class=""></li>
                                            <li id="none2-tag-4" class=""></li>
                                            <li id="none3-tag-4" class=""></li>
                                            <li id="none4-tag-4" class=""></li>
                                            <li id="add-tag-4" class="dynamic-demo-add-tag" style="align-self: flex-end;">
                                                <img src="images/create_comment.png" width="30" height="30" title="Add Comment" alt="Add Comment" class="tooltip_"/>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="demo-box" role="group" aria-label="...">
                                        <input type="hidden" id="ct_4" name="ct_4" />
                                        <label for="bottom_text_tag_4">Short Comment:&nbsp;*</label>
                                        <input type="text" id="bottom_text_tag_4" name="bottom_text_tag_4" disabled="disabled" value="" size="50" maxlength="50" required placeholder="Short Comment visible in Video"/><br/>
                                        <label for="text_tag_4">Long Comment:&nbsp;</label>
                                        <textarea id="text_tag_4" name="text_tag_4" rows="3" cols="70" style="resize: none;" disabled="disabled" placeholder="Long Comment of video, not visible in video"></textarea><br/>
                                        <label for="textOver_4">Options Short Comment:&nbsp;</label>
                                        <div class="checkbox" id="buttom_4">
                                            <label>
                                                <input id="dynamic-demo-bold-4" name="dynamic-demo-bold-4" type="checkbox">
                                                <img src="images/bold.png" class="button-edit tooltip_" width="22" height="22" title="Bold Text" alt="Bold"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-demo-italy-4" name="dynamic-demo-italy-4" type="checkbox">
                                                <img src="images/italic.png" class="button-edit tooltip_" width="22" height="22" title="Italy Text" alt="Italy"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-underline-4" name="dynamic-demo-underline-4" type="checkbox">
                                                <img src="images/underline.png" class="button-edit tooltip_" width="22" height="22" title="Underline Text" alt="Underline"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-left-4" name="dynamic-demo-left-4" type="checkbox">
                                                <img src="images/left.png" class="button-edit tooltip_" width="22" height="22" title="Left Text" alt="Left"/>
                                            </label>&nbsp;
                                            <label>
                                                <input id="dynamic-dynamic-demo-center-4" name="dynamic-demo-center-4" type="checkbox">
                                                <img src="images/center.png" class="button-edit tooltip_" width="22" height="22" title="Center Text" alt="Center"/>
                                            </label>&nbsp;&nbsp;
                                            <img src="images/save.png" class="dynamic-demo-add button-edit tooltip_" width="22" height="22" title="Save" alt="Save"/>
                                            &nbsp;&nbsp;
                                            <img src="images/cancel.png" class="dynamic-demo-cancel button-edit tooltip_" width="22" height="22" title="Cancel Edition Comment" alt="Cancel"/>
                                        </div>
                                        <input type="hidden" id="textOver_4" name="textOver_4" />
                                        <input type="hidden" id="id_4" name="id_4" />
                                        <input type="hidden" id="ed_4" name="ed_4" value="N" />
                                    </div>
                                    <div class="demo-box" >
                                        <ul id='marker-list-4' class="dynamic-demo-events list-group tag-list">
                                        </ul>
                                    </div>
                                    <div id="text-controls_4" class="demo-edit-buttons">
                                </div>
                                </div>
                            </div>
                        </div>
