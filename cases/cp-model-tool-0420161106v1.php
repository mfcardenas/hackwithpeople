...
<head>
    ...
    <script src="js/json-caption-cp-model-tool-0420161106v1.js" type="text/javascript"></script>
</head>
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1>
                    <a href="cp-model-tool-0420161106v1.html"><img src="images/ucm-ws.png" alt=""/>CAM ASSISTANT</a>
                </h1>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="center_element">
                            <input type="hidden" id="videoFile1" size="60" maxlength="250" class="tooltip_ video_cam" style="width: 450px;" title="Video 1 file input field"
                                   value="videos/video-model-tool-cp-1.mp4" readonly="readonly"/>
                        ...
                        <div class="area-grids-heading heading-video">
                            <div id="cam-title" class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    Presentamos un breve ejemplo del uso de la herramienta de modelado para generar simulaciones. Esta versión es para desarrollo y es posible integrarla con componentes de Android para ampliar funcionalidades. Descarga la presentación y envia tus sugerencias.
                                </div>
                                <input type="hidden" id="id_cp" name="id_cp" value="CAMASSISTANT-CP000006" />
                                <input type="hidden" id="id_cam" name="id_cam" value="CP000006-CAM1-VI01-20161015" class="id_cams"/>
                            </div>
                            <br/>
                        </div>
